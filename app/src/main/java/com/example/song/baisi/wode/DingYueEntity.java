...
public class DingYueEntity {

    private List<RecTagsEntity> rec_tags;
    private List<?> sub_tags;

    public List<RecTagsEntity> getRec_tags() {
        return rec_tags;
    }

    public void setRec_tags(List<RecTagsEntity> rec_tags) {
    ...
    public static class RecTagsEntity {
        /**
         * theme_name : 自拍
